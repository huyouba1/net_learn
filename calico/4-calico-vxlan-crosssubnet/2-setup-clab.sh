...
topology:
  nodes:
    ...
    server1:
      ...
      network-mode: container:calico-vxlan-crosssubnet-control-plane
      exec:
    ...
    server2:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:calico-vxlan-crosssubnet-worker
      exec:
    ...
    server3:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:calico-vxlan-crosssubnet-worker2
      exec:
    ...
    server4:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:calico-vxlan-crosssubnet-worker3
      exec:
