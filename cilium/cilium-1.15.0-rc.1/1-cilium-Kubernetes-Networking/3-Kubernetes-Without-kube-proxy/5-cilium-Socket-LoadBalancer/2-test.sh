...
echo "********************************************************************"
echo "1. Flow: Pod-->NodePort Service [Socket Level LB]"
echo "********************************************************************"
echo "kubectl patch service wluo --type merge -p '{"spec": {"internalTrafficPolicy": "Cluster"}}'"
kubectl patch service wluo --type merge -p '{"spec": {"internalTrafficPolicy": "Cluster"}}'
echo "********************************************************************"
