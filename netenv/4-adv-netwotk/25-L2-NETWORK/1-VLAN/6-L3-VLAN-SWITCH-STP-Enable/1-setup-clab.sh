...
topology:
  nodes:
    br0:
      ...
      binds:
        ...
        - ./startup-conf/br0-boot.cfg:/opt/vyatta/etc/config/config.boot
  ...
  links:
    ...
    - endpoints: ["br0:eth1", "br1:eth3"]
    - endpoints: ["br0:eth2", "br2:eth3"]
    
    - endpoints: ["br1:eth4", "br2:eth4"]
