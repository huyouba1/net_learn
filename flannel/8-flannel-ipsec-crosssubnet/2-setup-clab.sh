...
topology:
  nodes:
    ...
    server1:
      ...
      network-mode: container:flannel-ipsec-crosssubnet-control-plane
      exec:
    ...
    server2:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-ipsec-crosssubnet-worker
      exec:
    ...
    server3:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-ipsec-crosssubnet-worker2
      exec:
    ...
    server4:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-ipsec-crosssubnet-worker3
      exec:
