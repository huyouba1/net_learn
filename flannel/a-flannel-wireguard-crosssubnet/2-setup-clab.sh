...
name: flannel-wireguard-crosssubnet
topology:
  nodes:
    gw0:
      kind: linux
    ...
    server1:
      ...
      network-mode: container:flannel-wireguard-crosssubnet-control-plane
      exec:
    ...
    server2:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-wireguard-crosssubnet-worker
      exec:
    ...
    server3:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-wireguard-crosssubnet-worker2
      exec:
    ...
    server4:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-wireguard-crosssubnet-worker3
      exec:
