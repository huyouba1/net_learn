...
topology:
  nodes:
    ...
    server1:
      ...
      network-mode: container:flannel-ipip-directrouting-control-plane
      exec:
    ...
    server2:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-ipip-directrouting-worker
      exec:
    ...
    server3:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-ipip-directrouting-worker2
      exec:
    ...
    server4:
      kind: linux
      image: 192.168.2.100:5000/nettool
      network-mode: container:flannel-ipip-directrouting-worker3
      exec:
